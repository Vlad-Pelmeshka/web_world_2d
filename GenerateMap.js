function GenerateMap(){
  ...
  //Random gamer
  do{
    gamer_y = Math.round(1 + (Math.random() * width_g-2));
    gamer_x = Math.round(1 + (Math.random() * height_g-2));

    console.log(gamer_y + ":" + gamer_x);
    //console.log(width_g);

    if(arr[gamer_y][gamer_x] == 'g'){
      break;
    }
    //break;
  }while(true);
